...
/**
 * ServerWorkflowTriggerManager - Server-side version for API routes
 */
export class ServerWorkflowTriggerManager {
...
export const serverWorkflowTriggerManager = new ServerWorkflowTriggerManager();